...
export const fields: Record<string, FieldConfig[]> = {
  members: [
    ...
    { name: "membershipPlan", label: "Membership Plan", required: true }, { name: "planPrice", label: "Plan Price", type: "number", readOnly: true }, { name: "discount", label: "Discount", type: "number" }, { name: "billingAmount", label: "Final Billing Amount", type: "number", readOnly: true },
    { name: "paymentMethod", label: "Payment Method", options: ["Cash", "UPI", "Card"], required: true },
  ...
  visitors: [
    { name: "visitorId", label: "Visitor ID", readOnly: true, placeholder: "Auto-generated" }, { name: "name", label: "Full Name", required: true }, { name: "mobile", label: "Mobile", required: true },
  ...
  trainers: [
    ...
    { name: "address", label: "Address" }, { name: "experience", label: "Experience (Years)", type: "number" }, { name: "specialization", label: "Specialization", required: true },
    { name: "qualification", label: "Qualification" }, { name: "joiningDate", label: "Joining Date", type: "date" },
    { name: "salary", label: "Salary", type: "number" }, { name: "status", label: "Status", options: ["Active", "Inactive", "On Leave"], required: true },
    { name: "emergencyContact", label: "Emergency Contact" }, { name: "profilePhoto", label: "Profile Photo URL" }
  ],
  staff: [
    ...
    { name: "email", label: "Email", type: "email" },
    {
      ...
      required: true,
      options: [
        "Receptionist", "Cleaner", "Housekeeping", "Security Guard", "Cashier", "Manager", "Accountant",
        "Office Assistant", "Maintenance Staff", "Sales Executive", "Marketing Staff", "Trainer",
        "Helper", "Support Staff", "Other"
      ]
    },
    { name: "customDesignation", label: "Custom Designation", placeholder: "e.g. Yoga Instructor" },
    { name: "joiningDate", label: "Joining Date", type: "date" },
  ...
  payments: [
    ...
    { name: "invoiceNo", label: "Invoice Number", placeholder: "Auto-generated if empty" },
    { name: "amount", label: "Amount", type: "number", required: true },
    { name: "method", label: "Payment Method", options: ["Cash", "UPI", "Card"], required: true },
    { name: "type", label: "Payment Type", options: ["Membership", "Membership Renewal", "Refund", "Pending Due"], required: true },
    { name: "status", label: "Status", options: ["Paid", "Pending", "Refunded"], required: true },
  ...
  diets: [
    { name: "name", label: "Plan Name", required: true },
    {
      ...
      label: "Template",
      required: true,
      options: ["Weight Loss", "Muscle Gain", "Maintenance", "Keto", "Vegetarian", "Vegan", "High Protein", "General Fitness"]
    },
    ...
    { name: "notes", label: "Nutrition Notes" },
    { name: "recommendations", label: "Trainer Recommendations" },
    { name: "status", label: "Status", options: ["Active", "Inactive"], required: true }
  ],
  equipment: [
    { name: "name", label: "Equipment Name", required: true },
    {
      ...
      label: "Category",
      required: true,
      options: ["Cardio", "Strength", "Free Weights", "Machines", "Accessories", "Recovery", "Other"]
    },
    ...
    { name: "serviceHistory", label: "Service / Repair Records" },
...
export const tableColumns: Record<string, string[]> = {
  ...
  staff: ["name", "mobile", "designation", "salary", "joiningDate", "status"],
...
export function fieldsFor(collection: string, data: AppData, memberValues?: Record<string, any>) {
  ...
  return (fields[collection] || []).map((field) => {
    ...
    if (collection === "members" && field.name === "paymentMethod") {
      const show = !memberValues?._id || Boolean(memberValues?._renewMode);
      return { ...field, hidden: !show, required: show };
    }
    if (collection === "staff" && field.name === "customDesignation") {
      return { ...field, hidden: memberValues?.designation !== "Other", required: memberValues?.designation === "Other" };
    }
    return field;
